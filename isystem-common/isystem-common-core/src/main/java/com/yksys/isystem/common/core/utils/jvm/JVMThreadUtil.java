...
public class JVMThreadUtil {
    ...
    public static void main(String[] args) {
        for(;;) {
            System.out.println("=======================================================================");
            System.out.println("getDaemonThreadCount: " + JVMThreadUtil.getDaemonThreadCount());
            System.out.println("getNonHeapMemoryUsage: " + JVMThreadUtil.getThreadCount());
            System.out.println("getPeakThreadCountAndReset: " + JVMThreadUtil.getAndResetPeakThreadCount());
            System.out.println("getDeadLockedThreadCount: " + JVMThreadUtil.getDeadLockedThreadCount());
            try {
                Thread.sleep(5000);
