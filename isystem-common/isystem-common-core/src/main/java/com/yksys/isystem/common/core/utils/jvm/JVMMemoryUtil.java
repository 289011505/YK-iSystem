...
public class JVMMemoryUtil {
    ...
    public static void main(String[] args) {
        ...
        for(;;) {
            System.out.println("=======================================================================");
            System.out.println("getHeapMemoryUsage: " + JVMMemoryUtil.getHeapMemoryUsage());
            System.out.println("getNonHeapMemoryUsage: " + JVMMemoryUtil.getNonHeapMemoryUsage());
            System.out.println("getEdenSpaceMemoryUsage: " + JVMMemoryUtil.getEdenSpaceMemoryUsage());
            System.out.println("getAndResetEdenSpaceMemoryPeakUsage: " + JVMMemoryUtil.getAndResetEdenSpaceMemoryPeakUsage());
            System.out.println("getSurvivorSpaceMemoryUsage: " + JVMMemoryUtil.getSurvivorSpaceMemoryUsage());
            System.out.println("getAndResetSurvivorSpaceMemoryPeakUsage: " + JVMMemoryUtil.getAndResetSurvivorSpaceMemoryPeakUsage());
            System.out.println("getOldGenMemoryUsage: " + JVMMemoryUtil.getOldGenMemoryUsage());
            System.out.println("getAndResetOldGenMemoryPeakUsage: " + JVMMemoryUtil.getAndResetOldGenMemoryPeakUsage());
            System.out.println("getPermGenMemoryUsage: " + JVMMemoryUtil.getPermGenMemoryUsage());
            System.out.println("getAndResetPermGenMemoryPeakUsage: " + JVMMemoryUtil.getAndResetPermGenMemoryPeakUsage());
            System.out.println("getCodeCacheMemoryUsage: " + JVMMemoryUtil.getCodeCacheMemoryUsage());
            System.out.println("getAndResetCodeCacheMemoryPeakUsage: " + JVMMemoryUtil.getAndResetCodeCacheMemoryPeakUsage());
